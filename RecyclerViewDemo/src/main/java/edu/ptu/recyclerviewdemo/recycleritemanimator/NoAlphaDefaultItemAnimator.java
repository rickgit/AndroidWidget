 ...
 * a RecyclerView. RecyclerView uses a NoAlphaDefaultItemAnimator by default.
 *
 * @see RecyclerView#setItemAnimator(RecyclerView.ItemAnimator)
 */
public class NoAlphaDefaultItemAnimator extends SimpleItemAnimator {
     ...
     * {@inheritDoc}
     * <p>
     * If the payload list is not empty, NoAlphaDefaultItemAnimator returns <code>true</code>.
     ...
     * then NoAlphaDefaultItemAnimator will call {@link #animateMove(ViewHolder, int, int, int, int)} and
