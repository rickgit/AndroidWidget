    ...
    public static void onRequestPermissionsResult(Activity activity, int requestCode, String[] permissions, int[] grantResults) {
        if (requestCode == mRequestCode) {
            if (verifyPermissions(grantResults)) {
                ...
                if (verifyNeverAskAgain(activity, permissions)) {
                    mOnPermissionListener.onNeverAskAgain();
//                    showTipsDialog(activity);
     ...
     * @param permissions
     * @return boolean
     * @author anshu.wang 2018-01-08 15:23:20
     **/
    private static boolean verifyNeverAskAgain(Activity activity, String[] permissions) {
        // 如果请求被取消，则结果数组为空
