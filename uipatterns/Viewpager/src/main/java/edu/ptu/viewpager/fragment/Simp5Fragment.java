...
public class Simp5Fragment extends SimpFragment {

    private int key=-2;

    public static Simp5Fragment getInstance(int i){
        Simp5Fragment simpFragment = new Simp5Fragment();
